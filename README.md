# `gametracer_jll.jl` (v0.2.1+0)

[![deps](https://juliahub.com/docs/gametracer_jll/deps.svg)](https://juliahub.com/ui/Packages/General/gametracer_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/f8742625849b0b0a526df3b3b1118e4fce96cd98/G/gametracer/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `gametracer_jll.jl` have been built from these sources:

* git repository: https://github.com/QuantEcon/gametracer.git (revision: `49ba14e396ddc21fbcd54621e610d355b7106c5e`)

## Platforms

`gametracer_jll.jl` is available for the following platforms:
